...
// const { PACKAGE_ROOT, PROJECT_ROOT } = require("./constants.js");
// const { BUILD_ROOT } = require("./constants");
//
...
//     // recursiveDirCopy(`${PROJECT_ROOT}/src/ports`, `${PACKAGE_ROOT}/ports`),
//     recursiveDirCopy(`${PROJECT_ROOT}/src/@types`, `${BUILD_ROOT}/@types`),
//   ]);
// };
//
